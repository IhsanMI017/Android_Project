package id.ac.poliban.mi.ihsan.powerreceiver_073;
...
public class CustomReceiver extends BroadcastReceiver {
    private static final String EXTRA_RANDOM_NUMBER = "id.ac.poliban.mi.ihsan.powerreceiver_073.RANDOM_NUMBER";
