package id.ac.poliban.mi.ihsan.simpleshoppinglist;
...
import id.ac.poliban.mi.ihsan.simpleshoppinglist.databinding.ActivityItemListBinding;

public class ItemListActivity extends AppCompatActivity {
    public final static String ITEM_TAG = "id.ac.poliban.mi.ihsan.simpleshoppinglist.EXTRA.ITEM";
